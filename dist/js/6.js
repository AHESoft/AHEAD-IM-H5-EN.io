...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Group settings")]), _vm._v(" "), _c('a', {
    attrs: {
      "slot": "left"
    },
    slot: "left"
    ...
    nativeOn: {
      "click": function($event) {
        return (function () { return _vm.onEditItemClick(_vm.hasEditPermission ? 'Change group name' : 'Group name', 'text', 'name'); })($event)
      }
    }
  }), _vm._v(" "), _c('cell', {
    attrs: {
    ...
    nativeOn: {
      "click": function($event) {
        return (function () { return _vm.onEditItemClick('Change group nickname', 'text', 'nickInTeam', true); })($event)
      }
    }
  }), _vm._v(" "), _c('cell', {
    attrs: {
    ...
    nativeOn: {
      "click": function($event) {
        return (function () { return _vm.onEditItemClick(_vm.hasEditPermission ? '修改Introduction' : 'Introduction', 'textarea', 'intro'); })($event)
      }
    }
