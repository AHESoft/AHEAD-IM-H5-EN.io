<template>
  <div class="g-inherit m-main p-session">
    <group class="u-list">
      <cell class="u-list-item" title="Message center" @click.native="enterSysMsgs">
        <img class="icon" slot="icon" width="24" :src="noticeIcon">
        <span v-show="sysMsgUnread > 0" class="u-unread">{{sysMsgUnread}}</span>
      </cell>
      <cell class="u-list-item" title="My mobile" @click.native="enterMyChat">
