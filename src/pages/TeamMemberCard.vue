<template>
  <div class='g-inherit m-article p-membercard'>
    ...
    <div class='g-body'>
      ...
      <group class='m-group'>
        <cell title="群Nickname" :value="member.nickInTeam||'未设置'" @click.native="()=> hasSetNickPermission? onEditItemClick('修改群Nickname', 'text', 'nickInTeam', getUpdateCallBcak()) : $toast('无权限')" is-link></cell>
